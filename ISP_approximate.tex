...
\author{Paulo Garcia, Mehryar Emambakhsh, Andrew Wallace\\
\IEEEcompsocitemizethanks{
\IEEEcompsocthanksitem P. Garcia, M. Emambakhsh and A. Wallace are with the School of Engineering and Physical Sciences,
Heriot-Watt University, Edinburgh EH14 4AS, U.K. E-mail: \{p.garcia, a.m.wallace\}@hw.ac.uk.
}
...
% The paper headers
\markboth{IEEE Transactions on Circuits and Systems for Video Technology,~Vol.~XX, No.~X, August~XXXX}%
...
\section{Background and related work}
	...
	\subsection{Prior knowledge in sensing}
\section{Prior knowledge for runtime approximations}
\section{Proof of concept: extended kalman filter}
...
applications) and EP/K014277/1 (MOD University Defence Research Collaboration in Signal Processing).
